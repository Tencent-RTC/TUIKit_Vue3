...
const DEFAULT_GROUP_AVATAR_AVCHATROOM = 'https://web.sdk.qcloud.com/im/demo/TUIkit/react-static/images/group_avatar_AVChatRoom.png';
const DEFAULT_GROUP_AVATAR_COMMON = 'https://web.sdk.qcloud.com/im/demo/TUIkit/web/img/constomer.png';

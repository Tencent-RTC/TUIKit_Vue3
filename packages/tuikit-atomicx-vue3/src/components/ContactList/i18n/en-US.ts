export default {
  ...
  // ContactList component translations
    ...
    'Friend application sent, waiting for confirmation': 'Friend application sent, waiting for confirmation',
    ...
    'Requested': 'Requested',
    'Handled': 'Handled',
    'Friend application accepted': 'Friend application accepted',
    'Friend application rejected': 'Friend application rejected',
    'Friend application handled': 'This application has been handled',
    'remark': 'remark',
    'block': 'block',

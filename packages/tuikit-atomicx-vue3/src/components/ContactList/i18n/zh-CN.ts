export default {
  TUIContact: {
    ...
    'Friend application sent, waiting for confirmation': '申请已发出，等待对方确认',
    ...
    'Requested': '已申请',
    'Handled': '已处理',
    'Friend application accepted': '对方已通过好友申请',
    'Friend application rejected': '对方已拒绝好友申请',
    'Friend application handled': '该申请已处理',
    'remark': '备注',
    'block': '拉黑',

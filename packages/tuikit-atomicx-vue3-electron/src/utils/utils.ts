...
export function findLastIndex<T>(array: T[], predicate: (value: T, index: number, obj: T[]) => boolean, thisArg?: any): number {
 ...
 */
export const combineComparators = <T>(...comparators: Comparator<T>[]): Comparator<T> => {
  return (a, b) => {
...
export const createComparator = <T>(compareRules: (data1: T, data2: T) => boolean) => {
  return (a: T, b: T) => {

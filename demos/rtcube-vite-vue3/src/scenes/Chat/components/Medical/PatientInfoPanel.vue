...
import { ContactStore, useChatContext, Avatar } from '@tencentcloud/chat-uikit-vue3';
import {
  Activity,
  Phone,
  AlertCircle,
...
const avatar = computed(() => friendInfo.value?.avatarUrl);
...
const handleViewRecords = () => {
  console.log('[PatientInfoPanel] View full medical records', patient.value.avatar);
};
</script>

...
const filterLabelKey: Record<FilterType, string> = {
  all: 'scenes.chat.subScenes.medical.filter.all',
  pending: 'scenes.chat.subScenes.medical.filter.pending',
  active: 'scenes.chat.subScenes.medical.filter.active',
  done: 'scenes.chat.subScenes.medical.filter.done',
};

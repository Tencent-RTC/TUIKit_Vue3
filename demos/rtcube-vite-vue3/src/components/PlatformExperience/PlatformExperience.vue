...
import { reportQrcodeView } from '@/utils/aegis';

const { t } = useUIKit();

/**
 * Report platform QR code view event (remove for GitHub demo)
 * ext1 format: "home | platform" (e.g., "home | android")
 */
const handlePlatformView = (platformId: string, _platformName: string) => {
  reportQrcodeView('home', platformId);
};
